package com.natgeo.globalsites.pages;
...
@NamedUrls({			
	...
	@NamedUrl(name = "BrazilArticle", url = "/fotografia/2017/10/belezas-e-os-contrastes-de-salvador-vistos-do-alto"),
	@NamedUrl(name = "GermanyArticle", url = "/tiere/2017/07/die-rueckkehr-der-wildnis"),
	@NamedUrl(name = "FranceArticle", url = "/animaux/2018/01/pourquoi-les-oiseaux-sont-indispensables-notre-survie"),
	@NamedUrl(name = "PortugalArticle", url = "/espaco/2017/10/elon-musk-daqui-sete-anos-space-x-sera-capaz-de-levar-humanos-marte"),
	@NamedUrl(name = "SpainArticle", url = "/espacio/2017/08/una-insolita-tormenta-tan-ancha-como-la-tierra-aparece-sobre-neptuno"),
	@NamedUrl(name = "UKArticle", url = "/photography/2017/10/18-surreal-city-photos-suggest-future-has-arrived"),
	@NamedUrl(name = "MexicoArticle", url = "/historia/2017/12/siete-hallazgos-arqueologicos-imperdibles-de-2015"),
})
public class VisualBasePage extends GlobalSitesBasePage{
