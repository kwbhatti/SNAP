...
import com.natgeo.aemcore.scenarioSteps.VisualScenarioSteps;
...
public class AEMVisualStepDefinitions {
	String jobName;
	...
	@Then("^a screen capture is taken of the website and the results compaired to a baseline$")
