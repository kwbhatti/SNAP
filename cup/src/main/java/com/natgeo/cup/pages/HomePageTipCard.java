...
public class HomePageTipCard extends CupBasePage{

	public HomePageTipCard(WebDriver driver, int id) {
		super(driver);
	...
	private void initializeElements(int id) {
		card = find(By.cssSelector(".tip-card:nth-of-type("+ id +")")); 
		readButton = find(By.cssSelector(".tip-card:nth-of-type("+ id +") i")); 
	}
